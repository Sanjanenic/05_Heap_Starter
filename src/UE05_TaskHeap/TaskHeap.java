...
public class TaskHeap
{
    ...
    public boolean insert(Task t)
    {
        ...
        // TODO: In welcher Reihenfolge müssen die Anweisungen angeordnet sein, damit insert(...) korrekt funktioniert//gemacht!
        // d)
        if (isFull())
        {
    ...
    public Task remove()
    {
        ...
        // Die Anweisungen a) bis f) sind durcheinander gekommen.
        // TODO: In welcher Reihenfolge müssen die Anweisungen angeordnet sein, damit remove() korrekt funktioniert/gemacht!
